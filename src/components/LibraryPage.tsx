    ...
    <div className="pt-24 pb-12 px-6 max-w-5xl mx-auto relative min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.length > 0 ? courses.map((course, idx) => {
          const title = course.translations?.[language]?.title || course.title;
          const description = course.translations?.[language]?.description || course.description;
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-sm text-white truncate uppercase tracking-wide group-hover:text-brand-purple transition-colors">{title}</h3>
            ...
            >
              ...
              <div className="mb-8 pr-12">
                ...
                <h3 className="text-2xl font-bold text-white uppercase tracking-tight">
                  {selectedPolicy.translations?.[language]?.title || selectedPolicy.title}
                </h3>
              </div>
              ...
              <div className="overflow-y-auto flex-1 prose prose-invert prose-sm max-w-none scrollbar-hide">
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: selectedPolicy.translations?.[language]?.content || selectedPolicy.content || '' }}
                />
              </div>
